        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border"><h4 class="box-title">{{ $main_category->main_name }}</h3></div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-8 col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="main_name" class="form-control" placeholder="Maint Category Name" value="{{ $main_category->main_name }}">
                                        </div>
