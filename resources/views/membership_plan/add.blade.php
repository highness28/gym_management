            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h4 class="box-title">Membership Plan Information</h4>
                    </div>
                    <form method="POST" id="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                                ...
                                <div class="row">
                                     <div class="col-xs-12 col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Membership Name" name="name" value="{{ old('name') }}">
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <textarea name="details" rows="4" class="form-control" placeholder="Details"></textarea>
