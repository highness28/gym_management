            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h4 class="box-title">{{ $session_fee->name }}</h4>
                    </div>
                    <form method="POST" id="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                                ...
                                <div class="row">
                                     <div class="col-xs-12 col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Session Name" name="name" value="{{ $session_fee->name }}">
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Price" name="price" value="{{ $session_fee->price }}">
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Days" name="days" value="{{ $session_fee->days }}">
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <textarea name="details" rows="4" class="form-control" placeholder="Details" values="{{ $session_fee->details }}">{{ $session_fee->details }}</textarea>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="type" id="type">
                                                ...
                                                <option value="0" {{ $session_fee->type==0? 'selected':'' }}>Regular</option>
                                                <option value="1" {{ $session_fee->type==1? 'selected':'' }}>Training</option>
                                            </select>
                                        </div>
