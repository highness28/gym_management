                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="image_preview">
                                            ...
                                            <img src="{{ asset('dist/img/product/default.png') }}" class="prodImgPrev" id="prodImgPrev">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="main_category" id="main_category" class="form-control">
                                                ...
                                                @foreach($main_categories as $main_category)
                                                    <option value="{{ $main_category->id }}" {{ old('main_category')==$main_category->id? 'selected':'' }}>{{ $main_category->main_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="sub_category" id="sub_category" class="form-control">
                                                ...
                                                @foreach($sub_categories as $sub_category)
                                                    <option value="{{ $sub_category->id }}" {{ old('sub_category')==$sub_category->id? 'selected':'' }}>{{ $sub_category->sub_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-8">
                                        <textarea name="details" id="details" class="form-control" placeholder="Product Details" rows="5">{{ old('details') }}</textarea>
