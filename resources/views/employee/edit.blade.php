                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="image_preview">
                                            ...
                                            <img src="{{ asset('dist/img/avatar/'.$employee->image) }}" class="prodImgPrev" id="prodImgPrev">
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="gender" id="gender">
                                                ...
                                                <option value="0"
                                                    @if(old('gender')=='0' || $employee->gender == 0)
                                                        {{ 'selected' }}
                                                    @endif>Male
                                                </option>
                                                <option value="1"
                                                    @if(old('gender')=='1' || $employee->gender == 1)
                                                        {{ 'selected' }}
                                                    @endif>Female
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" placeholder="Birthday" name="birthdate" value="{{ date('m/d/Y', strtotime($employee->birthdate)) }}">
                                        </div>
                                     ...
                                     <div class="col-xs-4">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Mobile Number (09567108146)" name="contact_number" value="{{ $employee->contact_number }}">
                                        </div>
                             ...
                             <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Home Address" name="home_address" value="{{ $employee->home_address }}">
                                </div>
                            </div>
                              <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="Email Address" name="email" value="{{ $employee->email }}">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-circle-o"></i></span>
                                                <select class="form-control" name="user_type" id="user_type">
                                                    ...
                                                    <option value="0" {{ $employee->user_type==0? 'selected':'' }}>Cashier</option>
                                                    <option value="1" {{ $employee->user_type==1? 'selected':'' }}>Trainer</option>
                                                    @if(Auth::user()->user_type==3 || Auth::user()->user_type==4)
                                                        <option value="2" {{ $employee->user_type==2? 'selected':'' }}>Supervisor</option>
                                                    @endif
                                                    @if(Auth::user()->user_type==4)
                                                        <option value="3" {{ $employee->user_type==3? 'selected':'' }}>Owner</option>
                                                    @endif
                                                </select>
                                        </div>
                                            ...
                                            <select class="form-control" name="branch" id="branch" name="branch">
                                                ...
                                                @foreach($branches as $branch)
                                                    <option value="{{ $branch->id }}" 
                                                        @if(old('branch')==$branch->id || $employee->branch_id==$branch->id)
                                                            {{ 'selected' }}
                                                        @endif>{{ $branch->address }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        function genderChange(id) {
            if(!$('#image').val() && ("{{ $employee->image }}" == 'male_avatarc.png' || "{{ $employee->image }}" == 'female_avatarc.png')){
                // Female
                if(id==1) {
